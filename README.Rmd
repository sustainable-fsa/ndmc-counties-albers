...
The provenance of these boundaries matters: in response to a FOIA inquiry (documented in the [`fsa-lfp-counties`](https://sustainable-fsa.com/fsa-lfp-counties/) archive), the NDMC described its county layer as originating from an ESRI dataset obtained around 2008 and essentially unchanged since — even as the US Census has recorded hundreds of county boundary corrections and changes over the same period. Because LFP eligibility turns on whether qualifying drought touches *any area of a county*, the boundary layer used in that intersection is consequential to program administration. This archive preserves the geodatabase as distributed, so those determinations can be independently reproduced and audited.
