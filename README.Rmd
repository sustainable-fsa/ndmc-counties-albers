...
-   [`FSA_Counties_dd17.gdb.zip`](https://sustainable-fsa.com/fsa-counties-dd17/FSA_Counties_dd17.gdb.zip) – Original USDA File Geodatabase
-   [`fsa-counties-dd17.topojson`](https://sustainable-fsa.com/fsa-counties-dd17/fsa-counties-dd17.topojson) – Simplified TopoJSON version with pre-inset Alaska/Hawaii/Puerto Rico (see below)
-   [`fsa-counties-dd17.R`](https://sustainable-fsa.com/fsa-counties-dd17/fsa-counties-dd17.R) – R script that produces the Simplified TopoJSON versions
